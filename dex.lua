...
local function main()
	...
	Explorer.InitRightClick = function()
		...
		context:Register("BLOCK_REMOTE",{Name = "Block From Firing", IconMap = Explorer.MiscIcons, DisabledIcon = "Delete_Disabled",  Icon = "Delete", OnClick = function()
			local sList = selection.List
		...
		context:Register("UNBLOCK_REMOTE",{Name = "Unblock", IconMap = Explorer.MiscIcons, DisabledIcon = "Empty", Icon = "Play", OnClick = function()
			local sList = selection.List
			for i, list in sList do
				local obj = list.Obj
...
--[[
	Dex
	Infinite Yield Edition
	
	Maintained by Chillz and Toon.
	Originally developed by Moon.
]]
...
Main = (function()
	...
	Main.MissingEnv = {}
	Main.Version = "IY Edition"
	Main.Mouse = plr:GetMouse()
	Main.AppControls = {}
	Main.Apps = Apps
	Main.MenuApps = {}
	Main.GitRepoName = "who cares"
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Developed by Chillz and Toon.",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
