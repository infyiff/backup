...
Updates:Destroy() loadstring(game:HttpGet(('https://raw.githubusercontent.com/infyiff/backup/refs/heads/main/iyfd.lua'),true))() end UPDATE.MouseButton1Down:connect(Click) end 
